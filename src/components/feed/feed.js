    ...
    return this.state.posts.map(post => {
      if (this.state.filterType !== 'all') {
        if (post.type === 'text' && this.state.filterType === 'text') {
          return (
            <div className="section center card-panel" key={post.id}>
              <Link to={`/feed/${post.type}/${post.id}`} key={post.id}>
                <TextPost
                  onPostDelete={this.deletePost}
                  enableDelete={this.isMyPost(post)}
                  post={post}
                />
              </Link>
            </div>
    ...
    return (
      <div className="section right">
        ...
        <ul id="dropdown1" className="dropdown-content">
          <li>
            <a id="all" onClick={this.updateFilterType}>
              All posts
            </a>
          </li>
          <li className="divider" />
          <li>
            <a id="text" onClick={this.updateFilterType}>
              Text posts
            </a>
          </li>
          <li>
            <a id="video" onClick={this.updateFilterType}>
              Video posts
            </a>
          </li>
          <li>
            <a id="image" onClick={this.updateFilterType}>
              Image posts
            </a>
          </li>
        </ul>
    ...
    return (
      <div className="section center">
        <div className="fixed-action-btn">
          ...
          <ul className="">
            <li onClick={() => this.openModal('text')}>
              <a className="btn-floating red">
                <i className="material-icons">textsms</i>
              </a>
            </li>
            <li onClick={() => this.openModal('video')}>
              <a className="btn-floating blue darken-1">
                <i className="material-icons">videocam</i>
              </a>
            </li>
            <li onClick={() => this.openModal('image')}>
