        ...
        <div className="row">
          <div className="col s4 offset-s4">
            <div className="row profile-display z-depth-4">
              ...
              <div className="col s6">
                <span className="right">Posts: </span>
              </div>
              <div className="col s6">
                <span className="left">{postsCount}</span>
              </div>
              <div className="col s6">
                <span className="right">Comments: </span>
              </div>
              <div className="col s6">
                <span className="left">{commentsCount}</span>
              </div>
            </div>
          </div>
        </div>
        <div className="col s12 section">{this.renderModal()}</div>
      </main>
    );
  }
}
